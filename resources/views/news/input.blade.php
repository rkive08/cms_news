...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h4 class="m-0 font-weight-bold text-primary">Input Beita Baru</h4>
    </div>
    <div class="card-body">
        <div class="col-md-8 col-sm-12 bg-white p-4">
            <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="judul" placeholder="Tulis judul berita">
                </div>
                <div class="form-group">
                    <label><b>Deskripsi Singkat</b> </label>
                    <textarea class="form-control" name="ringkasan" rows="8"></textarea>
                </div>
                <div class="form-group">
