...
<head>
    ...
    <link href="{{ url('assets/backend/vendor/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://127.0.0.1:8000/home">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3 bg-light" style="border-radius: 10px;"><img src="{{ url('assets/backend/img/logo (2).png')}}" alt="" width="60%"></div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="http://127.0.0.1:8000/cetak">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <span class="mr-3 d-none d-lg-inline text-primary">&nbsp;&nbsp;&nbsp;<strong>{{ Carbon\Carbon::now()->translatedFormat('l, d F Y')}}</strong></span>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{ url('assets/backend/img/undraw_profile.svg')}}">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>ayuintennurillah ©2023 &bullet; Mini Project Test &bullet; CMS News &bullet; MangoHub</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">Pilih "Logout" di bawah jika Anda siap untuk mengakhiri sesi Anda saat ini.</div>
    ...
    <script src="{{ url('assets/backend/vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ url('assets/backend/js/demo/datatables-demo.js')}}"></script>
